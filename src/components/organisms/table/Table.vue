...
const items = [
  { title: i18n.global.t('datatableComponent.menu.addBreakfastDate'), value: 'addBreakfastDate' },
  { title: i18n.global.t('datatableComponent.menu.editMyAccount'), value: 'updateAccount' },
]
</script>
